...
export class DisciplineForm extends Component {
    state = {
        confirmDirty: false,
        autoCompleteResult: [],
    };
...
const DiscForm = Form.create()(DisciplineForm);
export default connect(mapStateToProps, mapDispatchToProps)(DiscForm);